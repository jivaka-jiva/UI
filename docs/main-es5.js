  ...
  (self["webpackChunkui"] = self["webpackChunkui"] || []).push([["main"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          29806)).then(function (m) {
            return m.FullPageLayoutModule;
          });
        }
      }, {
        path: '',
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() */
          "src_app_two-column-layout_two-column-layout_module_ts").then(__webpack_require__.bind(__webpack_require__,
          /*! ./two-column-layout/two-column-layout.module */
          24560)).then(function (m) {
            return m.TwoColumnLayoutModule;
          });
        }
      }];
      ...
      var _AuthGuard = /*#__PURE__*/function () {
        ...
        _createClass(_AuthGuard, [{
          ...
          value: function canLoad(route, segments) {
            ...
            return this.authService.checkLogin().then(function (isLoggedIn) {
              if (isLoggedIn) {
                return true;
              }
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _AuthService = /*#__PURE__*/function () {
        function _AuthService(storage, loadingController, router) {
        ...
        _createClass(_AuthService, [{
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 5:
                      ...
                      this.showLoader('Logging in').then(); //  TODO: Login API
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      return _context5.abrupt("return", this.showLoader('Welcome ' + registerData.name).then(function () {
                        return (0, tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(_this2, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                          var delay;
          ...
          value: function logout() {
            ...
            setTimeout(function () {
              ...
              _this3.router.navigateByUrl('login').then(function () {
